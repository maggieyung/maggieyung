...
**•	Programming:** Python, C, C#, Java, HTML/CSS, C++, PowerShell
...
• **Design:** Adobe Creative Cloud (After Effects, Illustrator, Photoshop), Aseprite, Blender, Clip Studio Paint, Krita, Canva, Procreate, Live2D
