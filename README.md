...
## 🫧 Tech Stack
**•	Packages:** Jupyter, Pandas, Matplotlib, Scikit-Learn, NumPy, WebGL, Seaborn, Keras, SciPy
...
**• Software:** Unity (UI Toolkit), Clip Studio Paint, Adobe Suite (Photoshop, After Effects), Blender, Git, Figma, Asesprite, Live2D
